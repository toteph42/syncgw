...
class fldMiddleName extends \syncgw\document\field\fldMiddleName {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldMiddleName {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
						  ...
						  '<BusinessAddressCity>Redmond</BusinessAddressCity><MiddleName>M.</MiddleName>'.
		 	...
		 	$cmp1 = '<Data><'.self::TAG.'>M.</'.self::TAG.'></Data>';
	   		$cmp2 = new XML();
	   		$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Contacts">M.</'.$xpath.'></Data>');
		}
