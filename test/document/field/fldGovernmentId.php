...
class fldGovernmentId extends \syncgw\document\field\fldGovernmentId {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldGovernmentId {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<GovernmentId>ID882792</GovernmentId><PhoneHome>88383777</PhoneHome><PhoneHomeNumber>(206) 555-0101</PhoneHomeNumber>'.
			...
			$cmp1 = '<Data><'.self::TAG.'>ID882792</'.self::TAG.'></Data>';
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Contacts2">ID882792</'.$xpath.'></Data>');
		}
