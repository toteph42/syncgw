...
class fldPager extends \syncgw\document\field\fldPager {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<PagerNumber>(206) 555-0102</PagerNumber><CompanyName>Contoso, Ltd.</CompanyName>'.
			...
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Contacts">(206) 555-0102</'.$xpath.'></Data>');
		}
