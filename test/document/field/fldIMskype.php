...
/*
 *  IM other messenger field handler
 *
 *	@package	sync*gw
...
class fldIMskype extends \syncgw\document\field\fldIMskype {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldIMskype {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<IMAddress>(206) 555-0100</IMAddress><FileAs>Kerry, Anat</FileAs>'.
					...
					'<IMAddress3>(206) 555-0102</IMAddress3><CompanyName>Contoso, Ltd.</CompanyName>'.
			...
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Contacts2">(206) 555-0100</'.$xpath.'></Data>');
		}
