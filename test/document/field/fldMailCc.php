...
class fldMailCc extends \syncgw\document\field\fldMailCc {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldMailCc {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.mail+xml') {
			...
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Mail">x@x.com, y@x.com</'.$xpath.'></Data>');
		}
