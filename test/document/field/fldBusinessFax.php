...
class fldBusinessFax extends \syncgw\document\field\fldBusinessFax {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldBusinessFax {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><BusinessFaxNumber xml-ns="activesync:Contacts">(206) 555-0100</BusinessFaxNumber></Data>');
		}
