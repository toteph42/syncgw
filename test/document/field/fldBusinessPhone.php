...
class fldBusinessPhone extends \syncgw\document\field\fldBusinessPhone {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldBusinessPhone {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.gal+xml') {
			$ext = new XML();
			$ext->loadXML('<syncgw><ApplicationData><Phone>(206) 555-0103</Phone>'.
					'</ApplicationData></syncgw>');
			$cmp1 = '<Data><'.self::TAG.'>(206) 555-0103</'.self::TAG.'></Data>';
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><Phone xml-ns="'.XML::CP[XML::AS_GAL].'">(206) 555-0103</Phone></Data>');
		}
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$cmp1 = '<Data><'.self::TAG.'>(206) 555-0103</'.self::TAG.'></Data>';
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><BusinessPhoneNumber xml-ns="'.XML::CP[XML::AS_CONTACT].'">(206) 555-0103</BusinessPhoneNumber></Data>');
		}
