...
class fldAssistantPhone extends \syncgw\document\field\fldAssistantPhone {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldAssistantPhone {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
						  ...
						  '<AssistantPhoneNumber>(206) 555-0102</AssistantPhoneNumber><CompanyName>Contoso, Ltd.</CompanyName>'.
			...
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><AssistantPhoneNumber xml-ns="activesync:Contacts">(206) 555-0102</AssistantPhoneNumber></Data>');
		}
