...
class fldURLOther extends \syncgw\document\field\fldURLOther {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$cmp1 = '<Data><'.self::TAG.'>http://www.contoso.com/</'.self::TAG.'></Data>';
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><WebPage xml-ns="activesync:Contacts">http://www.contoso.com/</WebPage></Data>');
		}
