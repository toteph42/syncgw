...
class fldRadioPhone extends \syncgw\document\field\fldRadioPhone {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldRadioPhone {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<RadioPhoneNumber>(206) 555-0100</RadioPhoneNumber><FileAs>Kerry, Anat</FileAs>'.
