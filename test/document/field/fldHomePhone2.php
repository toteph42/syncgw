...
class fldHomePhone2 extends \syncgw\document\field\fldHomePhone2 {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldHomePhone2 {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<Home2PhoneNumber>(206) 555-0100</Home2PhoneNumber><FileAs>Kerry, Anat</FileAs>'.
