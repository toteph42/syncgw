...
class fldSpouse extends \syncgw\document\field\fldSpouse {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldSpouse {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<Spouse>Anna Chikosz</Spouse><PhoneHome>88383777</PhoneHome><PhoneHomeNumber>(206) 555-0101</PhoneHomeNumber>'.
			...
			$cmp1 = '<Data><'.self::TAG.'>Anna Chikosz</'.self::TAG.'></Data>';
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Contacts">Anna Chikosz</'.$xpath.'></Data>');
		}
