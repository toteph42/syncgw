...
/*
 *  ICQ instant messenger field handler
 *
 *	@package	sync*gw
...
class fldIMicq extends \syncgw\document\field\fldIMicq {
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldIMicq {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.contact+xml') {
			...
			$ext->loadXML('<syncgw><ApplicationData><Body><Type>3</Type><EstimatedDataSize>5500</EstimatedDataSize>'.
					...
					'<IMAddress2>(206) 555-0102</IMAddress2><CompanyName>Contoso, Ltd.</CompanyName>'.
