...
class fldEndTime extends \syncgw\document\field\fldEndTime {
	...
	public function testClass(string $typ, float $ver, string $xpath): void {
		...
		if ($typ == 'application/activesync.calendar+xml') {
			...
			$cmp2 = new XML();
			$cmp2->loadXML('<Data><'.$xpath.' xml-ns="activesync:Calendar">20100801T000000Z</'.$xpath.'>'.
					'<AllDayEvent>0</AllDayEvent></Data>');
		}
