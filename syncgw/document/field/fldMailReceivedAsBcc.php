...
class fldMailReceivedAsBcc extends fldHandler {

	// module version number
	const VER = 2;

	// ----------------------------------------------------------------------------------------------------------------------------------------------------------
	const TAG 			= 'MailReceivedAsBcc';

   	/**
     * 	Singleton instance of object
     * 	@var fldMailReceivedAsBcc
     */
	 ...
	 *  @return - Class object
	 */
	public static function getInstance(): fldMailReceivedAsBcc {
		if (!self::$_obj) {
            self::$_obj = new self();
